...
<div id="faq" class="projects index large-9 medium-18 columns content float: left">
    ...
    For developers and managers:
          <ul >
            <li>A weekly report covers a calendar week and the first weekly report is written for week 3.</li>
    ...
    For managers:
      	<ul>    
            <li>The first week you'll need write a weekly report for is week 3.</li>
            <li>Submit the first weekly report on Monday, 23rd January 2017</li>
    ...
    <p>
      As a project manager:
      	<ul >
           <li>create a user ID (if you don't already have one) for yourself by signing up in MMT</li>
